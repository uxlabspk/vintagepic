...
export default function SignUp() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        console.log("Sign up:", formData, agreedToTerms);
    };
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-purple-900 flex items-center justify-center px-6 py-12">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-20 right-20 w-72 h-72 bg-purple-300 dark:bg-purple-700 rounded-full blur-3xl opacity-20 animate-float"></div>
                <div className="absolute bottom-20 left-20 w-72 h-72 bg-pink-300 dark:bg-pink-700 rounded-full blur-3xl opacity-20 animate-float" style={{ animationDelay: '1s' }}></div>
            </div>
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="glass rounded-3xl p-8 shadow-2xl animate-fade-in-up">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600 dark:text-gray-400">Join VintagePic and start sharing</p>
                    </div>
